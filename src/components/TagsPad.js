...
const TagsPad = (props) => {
  ...
  const thumbsDown = async (lst, t) => {
    ...
    const svgElement = document.getElementById(`thumbs down${JSON.stringify(t.status)}`);
